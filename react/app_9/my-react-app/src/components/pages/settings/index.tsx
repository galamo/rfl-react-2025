...
export default function SettingsPage() {
  const { timezone, setTimezone, dateFormat, setDateFormat } = useSettings();
  ...
  const handleCustomFormatSubmit = () => {
    if (customFormat.trim()) {
      setDateFormat(customFormat.trim());
      setIsCustom(true);
    }
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.settingSection}>
          ...
          {dateFormatPresets.map((preset) => (
            <button
              ...
              className={`${styles.dateFormatButton} ${
                dateFormat === preset.value && !isCustom ? styles.active : ""
              }`}
            ...
            >
              ...
              {dateFormat === preset.value && !isCustom && (
                <span className={styles.checkmark}>✓</span>
              )}
            </button>
          ))}
        ...
        <div className={styles.currentSetting}>
          <strong>Current format:</strong> {dateFormat}
