...
const ExpensesPage = () => {
    ...
    const limitedExpenses = useMemo(() => {
        return expensesArray.slice(0, state.expenseLimit);
    }, [expensesArray, state.expenseLimit]);
    ...
    return (
        <div className={styles.page}>
            <div className={styles.container}>
                ...
                {isLoading ? <SkeletonTable /> : <ExpensesTable data={limitedExpenses} />}


                <div className={styles.summaryBox}>
                    <div className={styles.summaryRow}>
                        <span>Showing {limitedExpenses.length} of {expensesArray.length} expenses (Limit: {state.expenseLimit})</span>
